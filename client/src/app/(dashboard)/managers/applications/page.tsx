...
const Applications = () => {
  ...
  if (isError)
    return (
      <div className='text-[14px] tracking-widest text-red-500 uppercase font-light'>
      ...
      <>
        ...
        <div className='mt-10 py-20 border-t border-zinc-100'>
          <p className='text-[14px] uppercase tracking-[0.4em] text-zinc-400 font-light'>
            You don&lsquo;t have any applications
          </p>
        </div>
      </>
    )
                    ...
                    <div className='flex justify-between gap-5 w-full pb-4 px-4'>
                      ...
                      <div className='flex gap-2'>
                        <Link
                          ...
                          className={`border border-gray-300 text-gray-700 py-2 px-4
